...
> **Runtime**: free-code + Kimi-K2.5-NVFP4 via synthetic.new
> **Model**: hf:nvidia/Kimi-K2.5-NVFP4
> **API**: https://api.synthetic.new/anthropic

## ABSOLUTE CONSTRAINT: ONLY skills and agents from THIS project

Your crew consists of **22 skills** (in `.claude/skills/`) and **21 core agents** (in `.claude/agents/`). free-code auto-loads both at session start.

The 21 core agents are:

**Productivity (8)**: `architect`, `scribe`, `sorter`, `seeker`, `connector`, `librarian`, `transcriber`, `postman`

**ML Research (6)**: `principal-investigator`, `literature-curator`, `experiment-runner`, `benchmark-keeper`, `idea-synthesizer`, `paper-writer`

**Engineering (5)**: `tech-lead`, `code-reviewer`, `mlops-engineer`, `security-engineer`, `performance-engineer`

**Data Science (2)**: `data-engineer`, `data-scientist`
...
**Model Configuration (Kimi-K2.5-NVFP4):**
- Use tool calling for all agent invocations
- Maximum context: 128k tokens
- Supports parallel tool execution
- Vision capabilities available via `vision_analyze` tool
...
| 14 | `/paper-ingest` | Ingest papers from arXiv/PDF with auto-summary and connection mapping. | "read this paper", "add arxiv", "arxiv 2501.12345", "paper summary", "ingest pdf" |
| 15 | `/sota-check` | Check state-of-the-art on benchmarks, compare your results. | "what's sota", "sota check", "are we competitive", "benchmark status", "leaderboard" |
| 16 | `/experiment-log` | Log experiment with full config, results, and observations. | "log experiment", "track run", "record results", "experiment results" |
| 17 | `/idea-generation` | Generate research ideas from paper combinations and gaps. | "generate ideas", "research ideas", "what should we try", "combine papers" |
| 18 | `/architecture-review` | System architecture review with scalability and cost analysis. | "architecture review", "system design", "tech stack", "scalability review" |
| 19 | `/security-audit` | Comprehensive security audit and threat modeling. | "security audit", "threat model", "vulnerability scan", "penetration test" |
| 20 | `/performance-optimization` | Performance profiling and optimization. | "optimize performance", "profile code", "find bottleneck", "memory optimization" |
| 21 | `/data-pipeline-design` | Design data pipelines for ML workflows. | "data pipeline", "ETL design", "feature pipeline", "data quality" |
| 22 | `/exploratory-analysis` | Comprehensive exploratory data analysis. | "analyze data", "EDA", "explore dataset", "statistical analysis" |
...
| 9 | **principal-investigator** | Research strategy, competition analysis, roadmap decisions |
| 10 | **literature-curator** | Paper ingestion, summarization, reading queue |
| 11 | **experiment-runner** | Experiment logging, ablations, checkpoint tracking |
| 12 | **benchmark-keeper** | SoTA tracking, competitive analysis, leaderboards |
| 13 | **idea-synthesizer** | Research idea generation, paper combinations |
| 14 | **paper-writer** | Academic writing, citations, submissions |
| 15 | **tech-lead** | System architecture, technical decisions, scalability |
| 16 | **code-reviewer** | Code quality, reviews, best practices |
| 17 | **mlops-engineer** | ML infrastructure, deployment, monitoring |
| 18 | **data-engineer** | Data pipelines, ETL, storage architecture |
| 19 | **data-scientist** | Data analysis, statistics, insights |
| 20 | **security-engineer** | Security audits, threat modeling, compliance |
| 21 | **performance-engineer** | Optimization, profiling, benchmarking |
| 22+ | **custom agents** | Any agent created via the Architect. Check `.claude/references/agents-registry.md` for triggers and capabilities. |
