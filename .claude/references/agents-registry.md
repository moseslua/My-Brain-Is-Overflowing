...
| principal-investigator | Research Strategy & Direction | Sets research directions, tracks competition, identifies gaps, prioritizes projects, resource allocation. | Research strategy, competition analysis, roadmap, prioritization | Research plans, competitive intelligence, gap analysis | active |
| literature-curator | Paper Management & Knowledge Graph | Ingests papers, generates summaries, maps connections, manages reading queue. | Paper ingestion, literature review, reading list | Paper notes, summaries, connections | active |
| experiment-runner | Experiment Tracking & Management | Logs experiments, tracks configs, manages ablations, finds best checkpoints. | Experiment logging, ablations, checkpoints | Experiment logs, results, analysis | active |
| benchmark-keeper | SoTA Tracking & Intelligence | Monitors benchmarks, tracks competition, alerts on new results. | SoTA checks, competitive analysis, leaderboards | Benchmark reports, gap analysis | active |
| idea-synthesizer | Research Idea Generation | Combines papers, identifies gaps, generates novel ideas. | Idea generation, paper combinations, gap analysis | Research ideas, hypotheses | active |
| paper-writer | Academic Writing & Publication | Drafts papers, manages citations, tracks submissions. | Paper drafting, citations, submissions | Paper drafts, submissions | active |
